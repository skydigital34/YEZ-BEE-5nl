...
export const YEZBEE_CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    ...
    banner: '/images/categories/party-wear.png',
    sortOrder: 2,
    hasFeedingSplit: true,
    subcategories: [
      {
  ...
  },
  {
    ...
    image: '/images/categories/lounge-wear.png',
    banner: '/images/categories/lounge-wear.png',
    sortOrder: 4,
  ...
  },
  {
    ...
    banner: '/images/categories/peplum-tops.png',
    sortOrder: 5,
    hasFeedingSplit: true,
    subcategories: [
      {
